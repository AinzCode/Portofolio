// Main Content Component - All subsections (About, Skills, Education, Projects, Contact)
import { mainStyles as styles } from './styles';

export function createMainContent(): string {
  return `
    <section id="main-content" class="${styles.section}">
        <div class="${styles.container}">
            <!-- About Subsection -->
            <div class="${styles.subsection}" id="about">
            ...
            <!-- Contact Subsection -->
            <div class="${styles.subsection}" id="contact">
...
export function initializeMainContent(): void {
